...
const TrusteeCard: React.FC<TrusteeCardProps> = ({ trustee }) => {
  return (
    <div
      ...
      className="rounded-xl p-4 flex flex-col gap-4 w-[25rem] flex-1 card-bg-blur bg-neutral-50 border border-transparent hover:border-neutral-500 bg-opacity-15"
    >
